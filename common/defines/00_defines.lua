...
NMilitary = {
	...
	LAND_AIR_COMBAT_STR_DICE_SIZE = 1.5,                 -- nr of damage dice (used by air to ground)
	LAND_AIR_COMBAT_ORG_DICE_SIZE = 4,                 -- nr of damage dice (used by air to ground)
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.025,    -- air global strength damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.025,    	-- air global organization damage modifier
...
NAir = {
	...
	COMBAT_BETTER_AGILITY_DAMAGE_REDUCTION = 0.75, 		-- How much the better agility (than opponent's) can reduce their damage to us.
...
NNavy = {
	...
	NAVAL_MINES_ACCIDENT_CRITICAL_HIT_CHANCES = 0,				-- If an accident happens, how likely it is to be a critical hit (caused by naval mines)
	NAVAL_MINES_ACCIDENT_CRITICAL_HIT_DAMAGE_SCALE = 0,			-- Scale the value below in case of critical hit (caused by naval mines)
	NAVAL_MINES_ACCIDENT_STRENGTH_LOSS = 0,						-- Amount of strength loss when hit by naval mine
	NAVAL_MINES_ACCIDENT_ORG_LOSS_FACTOR = 0,						-- Amount of strength loss when hit by naval mine
...
NDoctrines = {
        DEFAULT_REWARD_MASTERY = 0,                         -- How much mastery is required for unlocking a doctrine reward, if no override is set
